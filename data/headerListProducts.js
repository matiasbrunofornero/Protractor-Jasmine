'use strict';
module.exports = {
	'Vuelos': { order: 1, text: 'Vuelos', url: 'https://www.turismocity.com.ar/vuelos', iconClassName: 'icon-vuelos' },
	'Hoteles': { order: 2, text: 'Hoteles', url: 'https://www.turismocity.com.ar/hoteles', iconClassName: 'icon-hoteles' },
	'Paquetes': { order: 3, text: 'Paquetes', url: 'https://www.turismocity.com.ar/paquetes', iconClassName: 'icon-paquetes' },
